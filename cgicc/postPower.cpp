...
int main(){
   ...
   cout << body() << h1("BeagleBone POST Power Example") << endl;;
   cout << "<form action=\"/cgi-bin/postPower.cgi\" method=\"POST\">\n";
   ...
   if (command=="on") i = system("echo 1 > /sys/class/gpio/gpio65/value"); // turn the Power on?
   else if (command=="off") i = system("echo 0 > /sys/class/gpio/gpio65/value"); // off?
